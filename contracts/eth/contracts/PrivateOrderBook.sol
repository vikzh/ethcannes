...
contract PrivateOrderBook is ReentrancyGuard, Pausable, Ownable {
     ...
     */
    function addOrder(Order memory newOrder) external whenNotPaused nonReentrant returns (uint256 orderId) {
        ...
        for (uint256 i = 0; i < orders.length; i++) {
            ...
            if (existingOrder.fromToken == newOrder.toToken && existingOrder.toToken == newOrder.fromToken) {
