...
library MpcCore {
    ...
    function requestDecryption(uint256 decryptID, uint256[] memory handles, bytes4 callbackSelector) internal {
        GCExtendedOperations(address(GCExtendedOperationsAddress)).RequestDecryption(decryptID, handles, callbackSelector);
    }
...
// =========== 1 bit operations ==============
    ...
    function rand() internal returns (gtBool) {
        return gtBool.wrap(GCExtendedOperations(address(GCExtendedOperationsAddress)).Rand(bytes1(uint8(MPC_TYPE.SBOOL_T))));
    }
 ...
 // =========== 8 bit operations ==============
    ...
    function rand8() internal returns (gtUint8) {
        return gtUint8.wrap(GCExtendedOperations(address(GCExtendedOperationsAddress)).Rand(bytes1(uint8(MPC_TYPE.SUINT8_T))));
    }

    function randBoundedBits8(uint8 numBits) internal returns (gtUint8) {
        return gtUint8.wrap(GCExtendedOperations(address(GCExtendedOperationsAddress)).RandBoundedBits(bytes1(uint8(MPC_TYPE.SUINT8_T)), numBits));
    }
    ...
    function checkedAddWithOverflowBit(gtUint8 a, gtUint8 b) internal returns (gtBool, gtUint8) {
        (uint256 bit, uint256 res) = GCExtendedOperations(address(GCExtendedOperationsAddress)).
 ...
 // =========== 16 bit operations ==============
    ...
    function rand16() internal returns (gtUint16) {
        return gtUint16.wrap(GCExtendedOperations(address(GCExtendedOperationsAddress)).Rand(bytes1(uint8(MPC_TYPE.SUINT16_T))));
    }

    function randBoundedBits16(uint8 numBits) internal returns (gtUint16) {
        return gtUint16.wrap(GCExtendedOperations(address(GCExtendedOperationsAddress)).RandBoundedBits(bytes1(uint8(MPC_TYPE.SUINT16_T)), numBits));
    }
    ...
    function validateCiphertext(itUint32 memory input) internal returns (gtUint32) {
        return gtUint32.wrap(GCExtendedOperations(address(GCExtendedOperationsAddress)).
    ...
    function rand32() internal returns (gtUint32) {
        return gtUint32.wrap(GCExtendedOperations(address(GCExtendedOperationsAddress)).Rand(bytes1(uint8(MPC_TYPE.SUINT32_T))));
    }

    function randBoundedBits32(uint8 numBits) internal returns (gtUint32) {
        return gtUint32.wrap(GCExtendedOperations(address(GCExtendedOperationsAddress)).RandBoundedBits(bytes1(uint8(MPC_TYPE.SUINT32_T)), numBits));
    }
...
// =========== 64 bit operations ==============
    ...
    function validateCiphertext(itUint64 memory input) internal returns (gtUint64) {
        return gtUint64.wrap(GCExtendedOperations(address(GCExtendedOperationsAddress)).
    ...
    function rand64() internal returns (gtUint64) {
        return gtUint64.wrap(GCExtendedOperations(address(GCExtendedOperationsAddress)).Rand(bytes1(uint8(MPC_TYPE.SUINT64_T))));
    }

    function randBoundedBits64(uint8 numBits) internal returns (gtUint64) {
        return gtUint64.wrap(GCExtendedOperations(address(GCExtendedOperationsAddress)).RandBoundedBits(bytes1(uint8(MPC_TYPE.SUINT64_T)), numBits));
    }
