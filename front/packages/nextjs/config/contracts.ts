...
export const CONTRACT_DEPLOYMENT_BLOCKS = {
    84532: 0, // TODO: Update when contracts are deployed on Base Sepolia
  } as const;
  
  // Proxy service URLs by chain ID
  export const PROXY_SERVICE_URLS = {
    84532: "https://proxy.bubble.sodalabs.net", // TODO: Update Base Sepolia proxy URL
  } as const;
  
  // Factory contract addresses by chain ID
  export const FACTORY_ADDRESSES = {
    84532: "0xda8aa6D0C7cB690A1EB54bEfFA537BB7A0deb01c", // Base Sepolia
  } as const;
  
  // Helper functions to get current chain configurations
  export const getContractAddresses = (chainId: number) => {
    // All contract addresses now come from subgraph data
    // This function is kept for backward compatibility but returns null
    console.warn("getContractAddresses is deprecated. Use subgraph data instead.");
    return null;
  };
  ...
  // Helper function to get token pairs for UI - now deprecated in favor of subgraph
  export const getTokenPairs = (chainId: number) => {
    // All token pairs now come from subgraph data
    console.warn("getTokenPairs is deprecated. Use subgraph data instead.");
    return [];
  };
